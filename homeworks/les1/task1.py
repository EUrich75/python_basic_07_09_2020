...
if profit > costs:
    print(f"Фирма работает с прибылью. Рентабельность выручки составит {profit / costs:.2f}")
    workers = int(input("Введите количество сотрудников фирмы "))
    print(f"прибыль фирмы на одного сторудника составит {(profit - costs) / workers:.2f}")
elif profit == costs:
